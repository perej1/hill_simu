...
Let $X_1, X_2, ..., X_n$ be i.d.d. random variables with a cdf $F$. Consider the  sample maxima $M_n = \max(X_1, X_2, ..., X_n)$. The limiting behavior of $M_n$ can be derived since $X_1, X_2,..., X_3$ are i.d.d.
\begin{gather*}
...
\section{Proofs}
All the proofs except the proof of Lemma \ref{U} follow proofs given in \cite{deHaan}. Some details are added.
